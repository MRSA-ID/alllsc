	...
	const radioBrandsCategoriesConfig = [
		{
			title: "Brand",
			filterKey: "brand",
			items: [{ id: "Tait", label: "Tait" }],
		},
		{
			title: "Sub Category",
			filterKey: "sub_category",
			items: [{ id: "DMR System", label: "DMR System" }],
		},
	];
	...
	return (
		<div className="bg-[#FFF] relative">
			<div className="hidden md:block !bg-[#253D6C99] text-[#FFF]">
				<div className="container mx-auto flex justify-center py-8 px-4 sm:px-8 lg:px-16">
					<div className="bg-[#b4c2dd70] rounded-[20px] flex flex-col gap-4 px-6 text-center max-w-[800px] py-4">
						<div className="font-bold text-xl">Radio Link & Data Solution</div>
						<div className="font-medium">
							Unlock the power of seamless data telemetry with our Radio Link &
							Data Solution. Transmit critical information in real-time,
							optimize performance, and stay connected across vast distances,
							revolutionizing the way you monitor and control your operations.
						</div>
					</div>
				</div>
			</div>
			...
			<div className="flex justify-center">
				<div className="flex flex-col md:flex-row md:container items-center px-4 sm:px-8 lg:px-16 py-4 pb-8">
					{/* show in mobile only */}
					<div className="text-lg text-[#FFF] z-10 md:hidden mb-4 mt-16 font-light">
						Unlock the power of seamless data telemetry with our Radio Link &
						Data Solution. Transmit critical information in real-time, optimize
						performance, and stay connected across vast distances,
						revolutionizing the way you monitor and control your operations.
					</div>
